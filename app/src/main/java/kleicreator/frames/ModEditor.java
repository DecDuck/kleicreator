...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        modEditorPanel.add(toolbar, gbc);
        final Spacer spacer1 = new Spacer();
        toolbar.add(spacer1);
        toolbarSave = new JButton();
        toolbarSave.setEnabled(true);
        toolbarSave.setHorizontalAlignment(0);
        toolbarSave.setHorizontalTextPosition(0);
        ...
        modItemConfigPanel.add(spacer2, new GridConstraints(6, 0, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        ...
        modItemConfigPanel.add(spacer3, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
